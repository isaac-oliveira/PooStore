...
public class Loja {
    ...
    public void cadastrarVendas() {
        ...
        if (!Lista.contemVenda(vendas, data)) {
            ...
            if (cliente != null) {
                ...
                if (produto != null) {
                    System.out.print("Quantidade do produto comprada: ");
    ...
    /**
     * Função que de acordo com 'noEstoque' pode listar todos os produtos ou
     * filtrar os que estão no estoque
     *
     * @param noEstoque se for 'true' ele vai listar somente os produtos que
     * estão no estoque, caso contrário vai listar todos
     */
    ...
    /**
     * Pergunta se o usuário gostaria de aumentar a quantidade de algum produto
     * no estoque
     */
    ...
    /**
     * Solicita ao usuário o código do produto, a quantidade que foi adicionada
     * no estoque e atualizar o produto selecionado pelo código
     */
